...
from utils.argmax_funcs import argmax2D_last_stage


class LastAmountCorrectKeypointsMetric(tf.keras.metrics.Metric):
    def __init__(
        self,
        ...
        **kwargs
        ...
        super(LastAmountCorrectKeypointsMetric, self).__init__(name=name, **kwargs)
