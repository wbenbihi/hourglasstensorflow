...
from utils.argmax_funcs import argmax2D_mean


class MeanAmountCorrectKeypointsMetric(tf.keras.metrics.Metric):
    def __init__(
        self,
        ...
        **kwargs
        ...
        super(MeanAmountCorrectKeypointsMetric, self).__init__(name=name, **kwargs)
